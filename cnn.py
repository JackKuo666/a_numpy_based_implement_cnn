# -*- coding: utf-8 -*-
# 环境：python 3.6；numpy;pillow;IED:spyder:jupyter notebook;scipy;matplotlib
import numpy as np
import time
    ...
    def train_inner(self, data, label):
      ...
      #  print ("网络层数以及每层的网络shape:")
        for i in range(lay_num):
            ...
            np.save("./param/param_"+str(i)+".npy",out_data)
     ...
     #   print ("每层参数的shape:")
        ...
        for i in range(0, lay_num):
            ...
            np.save("./param/diff_"+str(i)+".npy",residual_out)
